...
These are the hard operational couplings; miss any of them and live hosts or
CI health gates break:
...
- **`skills/atrib/SKILL.md`: 67 hits; the file where a stale name does the most damage.**
