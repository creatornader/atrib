...
**Status**: STUB
**Spec anchors**: [§6 Key Directory](../../atrib-spec.md#6-public-key-directory)
...
- Per-operation log anchoring (§6.2.4): directory writes commit to the atrib log automatically
- Key rotation and revocation (§1.9, [D033](../../DECISIONS.md))
- Capability declarations (§6.7, [D051](../../DECISIONS.md)) — optional; verifiers can flag out-of-envelope records
...
- Spec: [§6](../../atrib-spec.md#6-public-key-directory)
