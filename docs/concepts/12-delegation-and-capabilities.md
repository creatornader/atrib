...
**Enables**: stable comparisons with OAuth, AP2, Verifiable Intent, ZCAP-LD, Vouch, and other agent authorization systems
...
- Concepts: [The trust model](06-trust-model.md), [Identity & the directory](03-identity-and-directory.md), [Payments integration](08-payments-integration.md)
