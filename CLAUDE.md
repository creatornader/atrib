...
atrib/
  ...
  scripts/
    ...
    update-primitives-runtime.mjs # D128 host-owned primitive runtime updater. Discovers local atrib-primitives LaunchAgents that run this checkout, builds recall plus primitives-runtime, restarts the selected services, calls recall_by_content over MCP Streamable HTTP, and requires the primitive topology gates to pass.
