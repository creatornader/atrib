...
atrib/
  ...
  scripts/
    ...
    report-local-substrate-topology.mjs # P042 live dogfood topology report. Reads process rows, sanitized startup-spawn configs, launchd service metadata, optional route-registry evidence, and health probes to separate healthy coordinators from duplicated or obsolete MCP primitive generations.
