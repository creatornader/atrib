...
atrib/
  ...
  docs/redesign-session-continuation.md # Continuation packet handed from the cloud redesign-analysis session to its local successor: session arc, corrections ledger, current state, remaining work with routing tiers, open operator decisions.
