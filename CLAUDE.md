...
atrib/
  ...
  services/
    ...
    archive-node/              # Production Record Body Archive Layer per §2.12. Separate from log-node. Stores opt-in signed record bodies and verifier evidence, confirms each body hash exists in a trusted log, and serves /v1/record plus /v1/evidence for explorer receipts.
...
This is a TypeScript monorepo with **twenty-four workspace packages**:
