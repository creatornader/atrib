  ...
  packages/
    ...
    integration/               # @atrib/integration: cross-package tests + runnable framework examples (private)
      ...
      scripts/
        ...
        proof-x401-node-runtime-interop.ts # Private Proof x401 Node SDK runtime adapter proof. Runs the published SDK, translates legacy wire output into current-spec x401 evidence, and keeps native SDK readiness gated.
