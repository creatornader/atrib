  ...
  packages/
    ...
    integration/               # @atrib/integration: cross-package tests + runnable framework examples (private)
      ...
      examples/
        ...
        browser-workflow/      # Browser-shaped observe/click/fill/submit receipt proof with hash-only atrib records and local sidecars.
