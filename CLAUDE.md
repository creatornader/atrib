...
atrib/
  ...
  DECISIONS.md                 # Architectural decision log (D001-D076; D070 + D073 are placeholder ADRs for the Record Body Archive Layer per §2.12 and the `handoff` event_type byte respectively; D071 codifies spec writing conventions; D072 governs orphan handling; D074 + D075 capture the git-trailer integration and compose-not-override hook config patterns; D076 introduces the opt-in long-lived atrib-emit daemon). A "Pending decisions" section at the end (forward-looking pattern) tracks a set of forward-looking decisions awaiting action (P002, P004, P005, P008, P009, P010, P012-P021). P012-P017 cover: P012 new §9 pattern for multi-agent orchestrator pre-delegation verification, P013 new §9 pattern for hosted-runtime adapter, P014 new §9 pattern for sandboxed-execution composition, P015 §1.4 normative MUST signing-key-outside-sandbox (SECURITY), P016 §0 positioning extension EveryDev mapping, P017 §8.7 Layer 11 environment-isolation boundary-trust. P018-P021 cover the eval framework adoption: P018 Inspect AI as Track B harness baseline, P019 pass^k as primary Track B reporting metric, P020 conformance corpus extension to Wycheproof-equivalent coverage, P021 publishable behavior-impact paired benchmark suite.
