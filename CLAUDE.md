  ...
  packages/
    ...
    integration/               # @atrib/integration: cross-package tests + runnable framework examples (private)
      ...
      scripts/
        ...
        proof-x401-node-runtime-interop.ts # Private Proof x401 Node SDK native proof. Runs a pinned current-spec SDK commit, emits current-spec x401 evidence, and keeps live npm readiness gated separately.
