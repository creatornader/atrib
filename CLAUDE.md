  ...
  packages/
    ...
    integration/               # @atrib/integration: cross-package tests + runnable framework examples (private)
      ...
      scripts/
        ...
        proof-vc-common-x401-interop.ts # Private Proof VC Common verifier bridge. Turns Proof credential-verifier output into caller-owned x401 resultVerified evidence.
