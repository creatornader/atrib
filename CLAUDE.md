...
atrib/
  ...
  spec/
    conformance/
      ...
      1.9/                     # Key rotation/revocation conformance corpus (test vectors for §1.9, D033). Skeleton; fixtures land in prior implementation work.
      ...
      6/                       # Public-key directory conformance corpus (test vectors for §6, D034). Skeleton; fixtures land in .
```
