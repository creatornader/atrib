...
This is a TypeScript monorepo with **twenty-nine workspace packages**:

- **Ten public SDK and integration packages** (`@atrib/mcp`, `@atrib/agent`, `@atrib/action-gate`, `@atrib/verify`, `@atrib/cli`, `@atrib/mcp-wrap`, `@atrib/directory`, `@atrib/openinference`, `@atrib/memory-tool`, `@atrib/runtime-log`)
