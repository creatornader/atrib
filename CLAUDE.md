...
atrib/
  ...
  DECISIONS.md                 # Architectural decision log (D001-D054; D040 reserved for the @atrib/recall harness ADR)
...
- **Log entry:** 90 bytes fixed: version(1) + record_hash(32) + creator_key(32) + context_id(16) + timestamp_ms(8) + event_type(1). See [§2.3.1](atrib-spec.md#231-entry-serialization).
