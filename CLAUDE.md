...
atrib/
  ...
  scripts/
    ...
    report-local-substrate-topology.mjs # P042 live dogfood topology report. Reads process rows, sanitized startup-spawn configs, launchd service metadata, optional route-registry evidence, primitive and bridge HTTP health, active-session profile state, bridge wrapper groups, and coordinator health to separate healthy routes from duplicated or obsolete child generations.
