...
| Seven cognitive primitives ([D079](../../DECISIONS.md#d079-the-six-core-cognitive-primitives--atribs-agent-facing-surface), [D106](../../DECISIONS.md#d106-verify-is-promoted-to-cognitive-primitive-7)) | Seven verbs across fourteen MCP tools: `atrib-emit`, `atrib-annotate`, `atrib-revise` (three writes, one tool each) + `atrib-recall` family (one verb, eight sibling tools: `recall_my_attribution_history`, `recall_by_content`, `recall_walk`, `recall_annotations`, `recall_revisions`, `recall_session_chain`, `recall_orphans`, `recall_by_signer`) + `atrib-trace`, `atrib-summarize`, `atrib-verify` (three more reads, one tool each)                                                                                                                                | All fourteen MCP tools present in the current process                                |
