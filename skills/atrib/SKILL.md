...
The skill is the practice; the substrate is the mechanism. As more producer/consumer surfaces ship (per the dogfooding architecture in `operator-internal dogfooding notes`), this skill will expand.
