...
2. After the upstream tool succeeds, the wrapper sends the same unsigned body with request `mode: "commit"`.
...
8. If `localSubstrate` is set, sends a shadow or commit request and logs the outcome.
