...
async function main() {
  ...
  const traceManifest = writeCorpus(
    ...
    'D068 + §3.4.5',
    'Provenance trace walks producer-claimed ancestry edges only (INFORMED_BY, ANNOTATES, REVISES). The structure-vs-claims invariant (§3.1) requires that CHAIN_PRECEDES NOT be walked. Cases enumerate the properties the corpus must preserve: multi-hop walk, the structural-edge prohibition, and depth truncation.',
