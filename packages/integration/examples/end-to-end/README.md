...
5. Switch to the production answer: "this is the dev log; the production log is `log.atrib.io/v1` and is Tessera-backed per spec §2, same wire format, same record shape, no client changes."
