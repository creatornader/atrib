 ...
 * decision-critical assertion: if any of the four producer-claim edges
...
describe('§3.2.4 cross-implementation conformance', () => {
  ...
  // ──────────────────────────────────────────────────────────────────────
  // Complete 9-edge regression: every spec edge type is reachable
  ...
  it('agrees on a complete 9-edge fixture (demo-vs-production drift guard)', async () => {
