...
- The checker mutates the healthy fixture to pin the knowledge-base receipt join-back failure mode where pending joins or active receipted WAL files keep the broad-default gate closed.
