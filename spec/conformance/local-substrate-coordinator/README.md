...
- `mixed-duplicated-agent-bridge-wrappers.json`: startup-spawn primitive hosting is healthy, but one app-server owns multiple Agent Bridge wrapper/upstream pairs, so the broad-default gate stays closed.
