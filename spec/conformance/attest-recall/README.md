...
| `persisted-labels/` | Mixed `_local.producer` labels (legacy and attest families) and a mixed D084 `calls.jsonl` fixture that readers and analyzers MUST accept; history is never rewritten. |
