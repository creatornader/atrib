...
| `cases/write-idempotency/`               | [D184](../../../DECISIONS.md#d184-stateless-mcp-writes-use-action-bound-idempotency-keys): completed retries replay the original result, a changed action binding is rejected, concurrent duplicates dispatch once, pending entries stay indeterminate across restart, context locks survive caller timeouts until primitive settlement, and keyed writes without a resolved context are rejected.                                                                                                                                                                                                                                                                                                                                                                                                                  |
