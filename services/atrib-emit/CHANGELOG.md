...
- 10cc623: Add an explicit watcher-WAL local-substrate commit path for `emitInProcess()` and `atrib-emit-cli`.
...
- 64490ba: Drop unvalidated informed_by refs before signing.
