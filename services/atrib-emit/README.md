...
| `ATRIB_LOCAL_SUBSTRATE_TIMEOUT_MS`                         | optional                   | Per local-substrate attempt timeout in milliseconds; defaults to `500`. Timeout, rejection, and invalid responses fall back to the local signing and queue path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
