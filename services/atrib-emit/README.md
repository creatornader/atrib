...
| `ATRIB_LOCAL_SUBSTRATE_ENDPOINT`                        | optional                   | Opt-in [P042](https://github.com/creatornader/atrib/blob/main/DECISIONS.md#p042-local-substrate-coordinator-for-long-lived-and-multi-harness-dogfood) local-substrate coordinator endpoint. When set with `ATRIB_LOCAL_SUBSTRATE_MODE=shadow`, emit sends a bounded shadow probe with the exact unsigned record body while local signing, mirror append, and queue submission remain authoritative.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `ATRIB_LOCAL_SUBSTRATE_MODE`                            | optional                   | Local-substrate rollout mode. Only `shadow` is honored by `@atrib/emit`; unset defaults to shadow when an endpoint is present. `commit` is ignored because coordinator-owned emit commit mode is not implemented.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ATRIB_LOCAL_SUBSTRATE_TIMEOUT_MS`                      | optional                   | Per-shadow-probe timeout in milliseconds; defaults to `500`. Timeout, rejection, and invalid responses are telemetry only and never affect the emitted record.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
`@atrib/emit` can send opt-in local-substrate shadow probes for the P042 `long-lived-agent` harness class. The direct emit path still owns the committed work:
