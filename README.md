...
| [`@atrib/runtime-log`](packages/runtime-log/README.md)             | Runtime-log proof helpers. Builds and verifies `log_window_manifest` objects for host-owned agent run windows. Workspace/tarball-only until its first npm publication is bootstrapped.                                                                                                                                   |
