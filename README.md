...
| [`@atrib/runtime-log`](packages/runtime-log/README.md)     | Runtime-log proof helpers. Builds and verifies bounded run-window manifests plus expected-surface coverage manifests that distinguish captured, skipped, degraded, and omitted actions.                                                                                                                                                                                                                                 |
