...
| Google stack chain proof           | [`packages/integration/examples/google-stack-chain/`](packages/integration/examples/google-stack-chain/) composes AP2 / VI receipt verification, A2A signed handoff evidence, and Google ADK Python plugin signing into one local proof ladder.                                                                                                                                                                                                                                                                                                                                                                      |
