...
| [`@atrib/verify`](packages/verify/README.md)               | Merchant and substrate verification. Re-runs the calculation locally, checks AP2 / VI and authorization evidence, verifies Pattern 3 handoff claims, and applies pinned-key checkpoint witness thresholds.                                                                                                                                                                                                              |
