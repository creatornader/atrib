...
| [`@atrib/verify`](packages/verify/README.md)               | Merchant verification. Re-runs the calculation locally, checks AP2 / VI evidence, and verifies Pattern 3 handoff claims.                                                                                                                                                                                                 |
