...
| [`@atrib/primitives-runtime`](services/atrib-primitives/README.md) | Private local MCP runtime: exposes all seven primitive packages through one stdio server for dogfood harnesses that would otherwise spawn one process per primitive.                                                                                                                                                     |
