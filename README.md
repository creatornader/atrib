...
| Google ADK plugin                  | [`packages/integration/examples/google-adk/`](packages/integration/examples/google-adk/), [`packages/integration/examples/google-adk-python/`](packages/integration/examples/google-adk-python/), and [`packages/integration/examples/google-adk-decision-ledger/`](packages/integration/examples/google-adk-decision-ledger/)                                                                                                                                                                                                                                                                                       |
| Google stack chain proof           | [`packages/integration/examples/google-stack-chain/`](packages/integration/examples/google-stack-chain/) links AP2 / VI receipt verification, A2A signed handoff evidence, a Google ADK JS allow decision, and the ADK JS tool outcome through verifier-resolved `informed_by` records, with a deterministic snapshot, BigQuery Agent Analytics-shaped local fixture, and a local visual workbench.                                                                                                                                                                                                                   |
